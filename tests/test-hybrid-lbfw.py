...
APP_NAME           = 'hybrid_lbfw'
APP_NAME_XDP       = f'{APP_NAME}_xdp'
APP_PATH           = f'/home/polycube/src/af_xdp-tests/examples/{APP_NAME}/{APP_NAME}'
APP_PATH_XDP       = f'/home/polycube/src/af_xdp-tests/examples/{APP_NAME}/{APP_NAME}_xdp'
...
RES_FILENAME       = 'res-hybrid-lbfw.csv'
RUNS               = 5
RETRIES            = 10
...
for run in range(RUNS):
    for drop_share in DROP_SHARES:
        for mode in MODES:
            ...
            app_path = APP_PATH_XDP if mode == 'xdp' else APP_PATH
            app_name = APP_NAME_XDP if mode == 'xdp' else APP_NAME
